...
class SuperCellTool(Tool):
    @staticmethod
    def add_args(parser):
        parser.description = "Extend the unit cell to supercell"
        ...
        parser.add_argument("-o", "--output", type=str, default=None,
                            help="the output STRU file name, default is {i}_{a}_{b}_{c}, where {i} is input file, and {a}, {b}, {c} is the supercell size")
        return parser
