...
def to_parser():
    return {
       ...
       # "Report":SubParser(model_report.ReportModel,model_report.ReportModelRunner,"report metrics.json"),
        ...
        "01-Phonon": SubParser(model_phonon.PhononModel,model_phonon.PhononModelRunner,"Calculate phonon"),    
        "02-FDForce":  SubParser(model_fdforce.FDForceModel,model_fdforce.FDForceModelRunner,"Do finite difference force calculation. Need info.txt file in each example inputs."), 
        "03-FDStress":  SubParser(model_fdstress.FDStressModel,model_fdstress.FDStressModelRunner,"Do finite difference stress calculation."),         
